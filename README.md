...
8.install .NET x on Ubuntu [Click here](https://www.iaspnetcore.com/Blog/BlogPost/593c6d0a84cd4518042eca6a/how-to-install-and-uninstall-reinstall-upgrade-net-x-on-ubuntu-200464)

9.run local web server
